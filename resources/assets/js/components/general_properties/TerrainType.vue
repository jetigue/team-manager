<template>
    <div v-if="editing" class="columns table-row m-0 px-4">
        ...
        <div class="column">
            <form action="/general-properties/terrain-types/id" method="POST" id="editTerrainType" @submit.prevent="update"
                  @keydown="form.errors.clear($event.target.name)">
                <div class="field is-horizontal">
                    <div class="field-label is-normal">
                        <label class="label">Terrain Type Name:</label>
                    </div>
...
<script>
    export default {
        ...
        methods: {
            update() {
                this.form
                    .patch('/api/general-properties/terrains/' + this.data.id)
            ...
            destroy() {
                axios.delete('/api/general-properties/terrains/' + this.data.id);
