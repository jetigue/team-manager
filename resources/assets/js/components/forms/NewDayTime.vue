<template>
    <form action="/api/training-properties/times" method="POST" id="newDayTimes" @submit.prevent="onSubmit"
          @keydown="form.errors.clear($event.target.name)">

        <div class="field">
            <label class="label" for="name">Day Time Name</label>
            <div class="control">
...
<script>
    export default {
        ...
        methods: {
            onSubmit() {
                this.form
                .post('/api/training-properties/times')
