<template>
    <form action="/api/general-properties/seasons" method="POST" id="newSeasonMethod" @submit.prevent="onSubmit"
        ...
        <div class="control" style="margin-top:25px;">
            <button class="button is-success is-pulled-right" :disabled="form.errors.any()">Create New Season</button>
        </div>
...
<script>
    export default {
        ...
        methods: {
            onSubmit() {
                this.form
                .post('/api/general-properties/seasons')
