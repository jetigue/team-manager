<template>
    <form action="/api/training-properties/feelings" method="POST" id="newRunFeeling" @submit.prevent="onSubmit"
          @keydown="form.errors.clear($event.target.name)">

        <div class="field">
            <label class="label" for="name">Run Feeling Name</label>
            <div class="control">
...
<script>
    export default {
        ...
        methods: {
            onSubmit() {
                this.form
                .post('/api/training-properties/feelings')
