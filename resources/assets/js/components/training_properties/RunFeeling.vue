<template>
    <div v-if="editing" class="columns table-row m-0 px-4">
        ...
        <div class="column">
            <form action="/api/training-properties/feelings/id" method="POST" id="editRunFeeling" @submit.prevent="update"
                  @keydown="form.errors.clear($event.target.name)">
                <div class="field is-horizontal">
                    <div class="field-label is-normal">
                        <label class="label">Feeling Name:</label>
                    </div>
...
<script>
    export default {
        ...
        methods: {
            update() {
                this.form
                    .patch('/api/training-properties/feelings/' + this.data.id)
            ...
            destroy() {
                axios.delete('/api/training-properties/feelings/' + this.data.id);
